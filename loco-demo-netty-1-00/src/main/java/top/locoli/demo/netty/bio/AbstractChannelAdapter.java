package top.locoli.demo.netty.bio;
 ...
 * 消息处理器抽象
 */
public abstract class AbstractChannelAdapter extends Thread {

    private Socket socket;
    private ChannelHandler channelHandler;
    private Charset charset;

    public AbstractChannelAdapter(Socket socket, Charset charset) {
        this.socket = socket;
